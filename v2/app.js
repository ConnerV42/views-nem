var express = require("express"),
    ...
    View = require("./models/campground");

mongoose.connect("mongodb://localhost/viewsdb");
...
// View.create({
//     name: "Monroe Street Dam", 
//     image: "https://farm5.staticflickr.com/4461/38066017492_a17699dd5a.jpg",
//     description: "A beautiful artificial waterfall located in Riverfront Park, in the middle of downtown Spokane."
    
// }, function(err, view){
//   if(err) {
//       console.log(err);
//   } else {
//       console.log("Added View to DB: " + view);
//   }
// });
