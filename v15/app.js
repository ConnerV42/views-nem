...
mongoose.connect("mongodb://localhost/viewsdb_v15");
...
app.use(function(req, res, next){
   ...
   res.locals.error = req.flash("error"); //passes content of flash error message variable present in the header.ejs file
